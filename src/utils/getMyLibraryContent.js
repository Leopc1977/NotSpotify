function getMyLibraryContent(spotifyApiSdk) {
    return new Promise((resolve, reject) => {
        const myLibrary = [];

        // Récupérer les artistes suivis
        const followedArtistsPromise = spotifyApiSdk.currentUser.followedArtists().then((followedArtistsResponse) => {
        ...
        const savedAlbumsPromise = spotifyApiSdk.currentUser.albums.savedAlbums().then((savedAlbumsResponse) => {
        ...
        const playlistsPromise = spotifyApiSdk.currentUser.playlists.playlists().then((playlistsResponse) => {
...
export default getMyLibraryContent;
